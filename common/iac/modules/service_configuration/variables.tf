variable "solution_configuration" {
  description = "Reference to the solution configuration settings to which the solution belongs."
  type        = map(any)
}
